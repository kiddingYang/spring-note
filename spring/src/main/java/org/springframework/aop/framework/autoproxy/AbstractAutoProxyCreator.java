...
public abstract class AbstractAutoProxyCreator extends ProxyConfig
    ...
    public Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) throws BeansException {
        ...
        if (beanName == null || !this.targetSourcedBeans.containsKey(beanName)) {
            ...
            // isInfrastructureClass 主要判断是是否是AOP基础建设类,如果是则不需要创建代理类
            // skip方法,是一个扩展的方法,留给子类实现
     ...
     *
     * 对给定的bean包装，比如符合代理的资格
     *
     * @param bean the raw bean instance 原始bean的实例
     * @param beanName the name of the bean bean的名称
     * @param cacheKey the cache key for metadata access 用于元数据访问缓存的key
     ...
     *
     * 返回给定的bean是否需要被代理,advices和advisors需要被应用
     *
     *
     * @param beanClass the class of the bean to advise  advice的class文件
     * @param beanName the name of the bean
     ...
     *
     * 返回特定bean被添加的拦截器数组，如果没有附加的拦截器只有一个通用的返回一个空数组，
     * 如果返回为null代表没有代理
     *
